...
module soc_system_mm_interconnect_1 (
	...
	wire  [116:0] switch_pio_s1_agent_rf_source_data;                             // switch_pio_s1_agent:rf_source_data -> switch_pio_s1_agent_rsp_fifo:in_data
	...
	wire  [116:0] switch_pio_s1_agent_rsp_fifo_out_data;                          // switch_pio_s1_agent_rsp_fifo:out_data -> switch_pio_s1_agent:rf_sink_data
	...
	wire  [115:0] switch_pio_s1_agent_rp_data;                                    // switch_pio_s1_agent:rp_data -> router_007:sink_data
	...
	wire  [115:0] uart_0_s1_agent_rp_data;                                        // uart_0_s1_agent:rp_data -> router_008:sink_data
	...
	wire  [115:0] cmd_mux_002_src_data;                                           // cmd_mux_002:src_data -> sysid_control_slave_burst_adapter:sink0_data
	wire          cmd_mux_002_src_ready;                                          // sysid_control_slave_burst_adapter:sink0_ready -> cmd_mux_002:src_ready
	wire    [7:0] cmd_mux_002_src_channel;                                        // cmd_mux_002:src_channel -> sysid_control_slave_burst_adapter:sink0_channel
	...
	wire  [115:0] cmd_mux_005_src_data;                                           // cmd_mux_005:src_data -> switch_pio_s1_burst_adapter:sink0_data
	wire          cmd_mux_005_src_ready;                                          // switch_pio_s1_burst_adapter:sink0_ready -> cmd_mux_005:src_ready
	wire    [7:0] cmd_mux_005_src_channel;                                        // cmd_mux_005:src_channel -> switch_pio_s1_burst_adapter:sink0_channel
	...
	wire  [115:0] switch_pio_s1_burst_adapter_source0_data;                       // switch_pio_s1_burst_adapter:source0_data -> switch_pio_s1_agent:cp_data
	...
	wire  [115:0] cmd_mux_006_src_data;                                           // cmd_mux_006:src_data -> uart_0_s1_burst_adapter:sink0_data
	wire          cmd_mux_006_src_ready;                                          // uart_0_s1_burst_adapter:sink0_ready -> cmd_mux_006:src_ready
	wire    [7:0] cmd_mux_006_src_channel;                                        // cmd_mux_006:src_channel -> uart_0_s1_burst_adapter:sink0_channel
